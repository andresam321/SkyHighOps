...
Revision ID: 9296bf4ac633
Revises: 
Create Date: 2024-05-31 11:18:45.013831
...
def upgrade():
    ...
    sa.Column('last_time_fueled', sa.DateTime(), nullable=True),
    ...
    op.create_table('aircraft_with_parking_spots',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('aircraft_with_parking_spots')
